...
\subsection{Thực nghiệm cho ADE (Hình 5 \& Hình 6)}
...
\begin{itemize}
    ...
    \item \textbf{Naive DML:} Áp dụng DML (AIPW \cite{robins1994estimation}) truyền thống, giả định i.i.d.\ và bỏ qua \(H_t\) trong mô hình kết quả.
...
\begin{figure}[H]
    ...
    \caption{Phân phối ước lượng điểm của ADE. Các phương pháp bỏ qua \(H_t\) (HT, Plug-in, Naive DML) bị chệch nặng; chỉ DML4SSI và SSAC tập trung quanh vạch 0 (giá trị thực).}
    \label{fig:ade_bias}
\end{figure}
...
\begin{figure}[H]
    ...
    \end{minipage}
    \caption{Độ phủ (trái) và Độ rộng (phải) của khoảng tin cậy 95\% cho ADE theo cỡ mẫu \(T\). Chỉ DML4SSI hội tụ đến mức phủ chuẩn 95\%; SSAC bị kẹt ở 60--70\% do đánh giá thấp phương sai.}
    \label{fig:ade_ci}
\end{figure}
...
\subsection{Thực nghiệm cho GATE trong Switchback (Hình 7, Hình 8 \& Hình 9)}
...
\begin{itemize}
    ...
    \item \textbf{Switchback HT (SB)} \cite{bojinov2022design}: bộ ước lượng không chệch được thiết kế đặc biệt cho thử nghiệm switchback.
\end{itemize}
...
\begin{figure}[H]
    ...
    \caption{Phân phối ước lượng điểm của GATE trong Switchback: DML4SSI so với các phương pháp naive. Các phương pháp naive bị chệch nặng; DML4SSI tập trung xung quanh giá trị thực.}
    \label{fig:gate_bias}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{So sánh DML4SSI với Switchback Horvitz-Thompson (SB). Cả hai đều không chệch nhưng DML4SSI có phương sai thấp hơn đáng kể (phân phối nhọn hơn).}
...
\begin{figure}[H]
    ...
    \caption{Độ phủ (trái) và Độ rộng (phải) của khoảng tin cậy 95\% cho GATE theo cỡ mẫu \(T\). DML4SSI hội tụ về 95\%; SB đạt 100\% do phương sai ước lượng quá bảo thủ, dẫn đến khoảng tin cậy rộng hơn DML4SSI từ 3 đến 7,5 lần.}
    \label{fig:gate_ci}
\end{figure}
