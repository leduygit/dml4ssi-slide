...
Bài báo ``Double Machine Learning for Causal Inference under Shared-State Interference'' của Hays và Raghavan \cite{hays2025double} đề xuất một khung lý thuyết và thực hành mới để suy luận nhân quả trong các hệ thống có nhiễu loạn trạng thái chung (SSI). Ba đóng góp chính gồm:
