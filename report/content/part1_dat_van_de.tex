...
\begin{itemize}
    ...
    \item \textbf{Thị trường / Sàn thương mại điện tử:} Khuyến mãi cho một nhóm người dùng làm thay đổi nhu cầu, giá cả, thời gian chờ và hàng tồn kho (trạng thái chung: lượng tồn kho, giá hiện tại, tín hiệu cầu) \cite{johari2022experimental}.
    \item \textbf{Gọi xe công nghệ:} Đối xử với một số hành khách làm thay đổi lượng tài xế trống cho những người khác (trạng thái chung: số tài xế trống, giá linh động, thời gian chờ) \cite{johari2022experimental}.
\end{itemize}
...
Bài báo đề xuất một dạng nhiễu loạn có cấu trúc, được gọi là \textbf{Shared-State Interference (SSI)} \cite{hays2025double}: nhiễu loạn không tùy tiện mà chảy qua một trạng thái chung quan sát được \(H_t\), thứ tóm gọn toàn bộ tác động lan tỏa (spillover) trong quá khứ.
...
Bài báo của Hays và Raghavan \cite{hays2025double} đóng góp ba điểm chính:
